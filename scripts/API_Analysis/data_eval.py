...
def evaluate_predictions_on_coco(
        coco_gt, json_result_file, iou_type='keypoints'):
...
if __name__ == "__main__":
    gt_path = r"G:\test_data\old_data\anno\person_keypoints_test2017.json" # 存放真实标签的路径             # r"G:\test_data\old_data\anno\person_keypoints_test2017.json"
    ...
    # Fix1_testdata_baidu_api_cocodt_format(score0.5).json
    dt_path = r"G:\test_data\old_data\anno\Fix_testdata_baidu_api_cocodt_format.json"    # 存放检测结果的路径

    cocoGt = COCO(gt_path)
    # coco_gt, json_result_file
    evaluate_predictions_on_coco(cocoGt, dt_path)
