...
newjson_dir = r'E:\left_hand_label_data\annotations\test2017\person_keypoints_test2017.json'
...
#         os.mkdir(path)
detect_start_index = 0
tool_start_index = 4913
pose_start_index = 4939
stride1 = 300
stride2 = 50
