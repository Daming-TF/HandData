...
image_path = r'F:\image\coco\train'       # r'F:\image\coco\train'

json_path = r'F:\image\coco\sort_coco_wholebody_train_v1.0.json'      # r'F:\image\coco\sort_coco_wholebody_train_v1.0.json'
