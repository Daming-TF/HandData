...
parser.add_argument("--json_folder", default=fr"F:\image\Rendered Handpose Dataset Dataset\RHD\RHD_published_v2\badcase\upload json", help="json folder that has corresponding json files")      # G:\test_data\hardcase_data\dataset\{name}\need_to_tag_data\anno
...
def main():
    ...
    for img_path, json_path in zip(img_paths, json_paths):
        ...
        upload_name = 'RHD_' + mode + "_" + os.path.basename(img_path)
