...
def set_parser():
    ...
    parser.add_argument("--TagJsonPath", help="无效数据的json文件路径",
                        default=r"E:\数据标记反馈\cmu-real(6129)\无效样本")
    ...
    parser.add_argument("--JsonSaveDir", help="更新后文件写入路径",
                        default=rf"F:\image\CMU\hand_labels\hand_labels_from_whole_body\annotations\person_keypoints_{mode}-update-for-invaliddata.json")       # person_keypoints_{mode}-update.json
