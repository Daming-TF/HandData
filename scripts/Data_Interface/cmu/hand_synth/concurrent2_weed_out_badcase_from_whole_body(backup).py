...
badcase_txt = r'F:\image\CMU\hand_labels\hand_labels\crop-image-badcase.txt'        # crop-image-badcase.txt
badcase_image_path = r'F:\image\CMU'       # crop-image路径(该路径指向+crop-image-badcase.txt可以指向badcase)
image_path = r'F:\image\CMU\hand_labels\hand_labels'        # 与全图数据路径有密切关联

json_path = r'F:\image\CMU\hand_labels\hand_labels'     # CMU每张数据原图对应一个json文件
save_path = r'F:\image\CMU\hand_labels\hand_labels\badcase'        # 数据保存路径
