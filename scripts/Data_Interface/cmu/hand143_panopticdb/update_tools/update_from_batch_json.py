...
def update(annotations_dict, keypoints_list, image_id, start_coco_id):
    ...
    for keypoints in keypoints_list:
        ...
        # hand_type = match_hand_type(keypoints, annotations_dict[image_id])

        coco_kps = keypoints.flatten().tolist()
        anno_dict = dict({
...
# def match_hand_type(match_keypoints, annotations_info_list):
#     match_index = None
