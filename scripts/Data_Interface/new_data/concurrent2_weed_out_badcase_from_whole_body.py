...
save_path = r'G:\test_data\new_data\new_data_from_whole_body_v2_6\weed_out_badcase'
...
def main():
    ...
    with open(json_path, 'r') as whole_json:
        ...
        images = whole_json_data['images']
        annotations = whole_json_data['annotations']
        ...
        for annotation_info in annotations:
            ...
            annotations_json_info.append(prieds)

        image_json_info = images
