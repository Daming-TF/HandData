...
def set_parser():
    ...
    parser.add_argument("--JsonPath", help="数据集json文件路径——cocoJson文件路径",
            default=rf"G:\imgdate2\HO3D_v3\HO3D_from_whole_body_v2_6\annotations\person_keypoints_train2017.json")
    parser.add_argument("--JsonSaveDir", help="更新后文件写入路径",
                        default=rf"G:\imgdate2\HO3D_v3\HO3D_from_whole_body_v2_6\annotations")
