...
def set_parser():
    ...
    parser.add_argument("--TagJsonPath", help="无效数据的json文件路径",
                        default=r"E:\数据标记反馈\ho3d(6127)\无效样本")
    ...
    parser.add_argument("--JsonSaveDir", help="更新后文件写入路径",
                        default=rf"G:\imgdate2\HO3D_v3\HO3D_from_whole_body\annotations\person_keypoints_{mode}-update-for-invaliddata.json")       # person_keypoints_{mode}-update.json
