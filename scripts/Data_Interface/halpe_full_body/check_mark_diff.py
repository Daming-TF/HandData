...
newjson_dir = r'E:\数据标记反馈\3月4日交付\6139-手势关键点-2022_2_15-7.json'


cv2.namedWindow('la', cv2.WINDOW_NORMAL)
with open(newjson_dir, 'r', encoding='UTF-8') as f:
    ...
    while 1:
        ...
        if file_name == 'val2017':
            ...
            image_dir = os.path.join(data_path, 'hico_20160224_det', 'images', 'train2015', 'HICO_train2015_'+image_name)
