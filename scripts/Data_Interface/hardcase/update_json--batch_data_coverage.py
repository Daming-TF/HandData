...
def set_parser():
    ...
    parser.add_argument("--TagJsonPath", help="重标打回数据的json文件路径",
                        default=r"E:\数据标记反馈\hardcase(5479)\批次样本")
    ...
    parser.add_argument("--JsonDir", help="数据集json文件路径——cocoJson文件路径",
                        default=rf"G:\test_data\hardcase_data\hardcase_from_whole_body\annotations\{mode}2017.json")
    parser.add_argument("--JsonSaveDir", help="更新后文件写入路径",
                        default=rf"G:\test_data\hardcase_data\hardcase_from_whole_body\annotations\{mode}2017-update-for-batchdata.json")
    parser.add_argument("--ImgSavePath", help="图片保存所在的路径",
                        default=r"G:\test_data\hardcase_data\hardcase_from_whole_body")
    parser.add_argument("--SearchPath", help="需要知道已用图像id",
                        default=r"G:\test_data\hardcase_data\hardcase_from_whole_body\images")
