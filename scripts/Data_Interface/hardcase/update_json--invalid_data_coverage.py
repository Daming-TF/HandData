...
def set_parser():
    ...
    parser.add_argument("--TagJsonPath", help="无效数据的json文件路径",
                        default=r"E:\数据标记反馈\hardcase(5479)\无效样本")
    ...
    parser.add_argument("--JsonSaveDir", help="更新后文件写入路径",
                        default=rf"G:\test_data\hardcase_data\hardcase_from_whole_body\annotations\{mode}2017-update-for-invaliddata.json")       # person_keypoints_{mode}-update.json
