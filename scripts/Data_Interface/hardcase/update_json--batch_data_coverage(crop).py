...
def set_parser():
    ...
    parser.add_argument("--JsonDir", help="数据集json文件路径——cocoJson文件路径",
                        default=rf"G:\test_data\hardcase_data\hardcase_from_crp_image\annotations\{mode}2017.json")
    parser.add_argument("--JsonSaveDir", help="更新后文件写入路径",
                        default=rf"G:\test_data\hardcase_data\hardcase_from_crp_image\annotations\{mode}2017-update-for-batchdata.json")
    parser.add_argument("--ImgSavePath", help="图片保存所在的路径",
                        default=r"G:\test_data\hardcase_data\hardcase_from_crp_image")
